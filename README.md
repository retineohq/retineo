...
<p align="center">
  <a href="https://github.com/retineohq/retineo/actions"><img src="https://img.shields.io/badge/tests-408%20passing-brightgreen" alt="Tests"></a>
...
- **MCP (Model Context Protocol):** Expose your knowledge base to any MCP-compatible agent. Tools: `echo_search`, `echo_add_note`, `echo_inspect`.
...
- **REST API:** Full CRUD for nodes, search, annotations, and batch operations.
...
| Test coverage | **408 tests passing** |
| Binary size | **< 15 MB** |
